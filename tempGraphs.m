...
% p=plot(wws(:,1:4),alphabetArray(:,:),'.','MarkerSize',12);
% xlim([0 100])
% ylabel('AlphabetRate')
% xlabel('Workload rating')
% title('Weighted workload scores vs Alphabet Rate')
...
% p=plot(wws(:,:),fNIRSArray(:,:),'.','MarkerSize',12);
% xlim([0 100])
% ylabel('fNIRS')
% xlabel('Workload rating')
...
% p=plot(metnal(:,:),fNIRSArray(:,:),'.','MarkerSize',12);
% xlim([0 100])
% ylabel('fNIRS')
% xlabel('Workload rating')
